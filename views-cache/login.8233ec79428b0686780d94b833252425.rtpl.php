...
<div class="login-box">
  <div class="login-logo">
    <a href="/index.php"><b>Tec Silva</b>/ Painel admin</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">logar para acesso ao sistema</p>

    <form action="/admin/login" method="post">
      <div class="form-group has-feedback">
        <input type="name" class="form-control" placeholder="Usuário" name="login">
