...
public static function getForgot($email, $inadmin = true){
       ...
       throw new \Exception("Não foi possivel recuperar a senha2");
         ...
         $dataRecovery = $results2[0];
             ...
             if ($inadmin === true) {
                 ...
                 $link = "http://www.tecsilva.com.br/admin/forgot/reset?code=$result";
             } else {
                 $link = "http://www.tecsilva.com.br/forgot/reset?code=$result";
             } 
  ...
  public static function setForgotUsed($idrecovery){
    ...
    $sql->query("UPDATE tb_userspasswordsrecoveries SET dtrecovery = NOW() WHERE idrecovery = NOW() WHERE idrecovery = :idrecovery", array(
      ":idrecovery"=>$idrecovery
